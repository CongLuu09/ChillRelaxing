package com.example.chillrelaxing.ui.Player.CafeChill;
        ...
        btnSaveSound.setOnClickListener(v -> {
            if (!layers.isEmpty()) {
                ...
                new Thread(() -> {
                    ...
                    db.deleteSoundsByScene("cafe");

                    for (LayerSound layer : layers) {
                        db.insertSound(layer.getName(), layer.getIconResId(), layer.getSoundResId(), "cafe");
